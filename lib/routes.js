...
module.exports = function (app) {
	...
	(async () => {
		...
		try {
			...
			app.get('/addShop', checkNotAuthenticated, isAccess, MySession, async function (req, res, next) {
				const error_msg = req.flash('error_msg');
				const success_msg = req.flash('success_msg');				
				res.render('addshop_shopify', { error_msg, success_msg, username, manage, amaz, etsy, shopify, majento, wooCommerce, bigCommerce, quickBooks, ebay });
			});
