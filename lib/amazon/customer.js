                                                                ...
                                                                if (result.records.length == 0) {
                                                                    conn.sobject("Contact").create(accUpExist,
                                                                        async function (err, rets) {
                                                                            ...
                                                                            pool.query('INSERT INTO jobs_log (id, email, updated_at, category, message, amazon_app_client_id) VALUES ($1, $2, $3, $4, $5, $6)', [uuid(), Email, updatedDate, 'amazon', 'Customer Sync', ClientId]);
