                                                                                    ...
                                                                                    if (orderItemAvailable != []) {
                                                                                        conn.sobject("OrderItem").create(orderItemAvailable,
                                                                                            async function (err, rets) {
                                                                                                ...
                                                                                                pool.query('INSERT INTO jobs_log (email, updated_at, category, message, amazon_app_client_id) VALUES ($1, $2, $3, $4, $5, $6)', [Email, updatedDate, 'amazon', 'Order Sync', ClientId]);
