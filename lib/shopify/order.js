                            ...
                            if (Email == result.rows[z].email) {
                                ...
                                if (!Aqxolt_Order_Profile && !Aqxolt_Customer && !Aqxolt_Channel && !accessToken || !shopName) {
                                    ...
                                    for (let i in OrdersArray) {
                                        if (OrdersArray[i].customer.id != "" && OrdersArray[i].customer.id != null) {
                                    ...
                                    for (let i in OrdersArray) {
                                        if (OrdersArray[i].customer.id != "" && OrdersArray[i].customer.id != null) {
                                            var list = {
                                                ...
                                                Name: OrdersArray[i].customer.first_name == "" && OrdersArray[i].customer.last_name ? OrdersArray[i].customer.id : OrdersArray[i].customer.first_name + " " + OrdersArray[i].customer.last_name,
                                    ...
                                    const uniq1 = new Set(customerId.map(e => JSON.stringify(e)));
                                    customerId = Array.from(uniq1).map(e => JSON.parse(e));

                                    console.log('CustomerDetails ' + JSON.stringify(CustomerDetails.length), customerId.length) //+ 'buyerEmailInfo ' + JSON.stringify(buyerEmailInfo.length))
                                                    ...
                                                    for (let j in OrdersArray) {
                                                        if (OrdersArray[j].customer.id == acc2Records[i].ERP7__Customer_External_Id__c) {
                                                            let acclist = {
                                                                ...
                                                                FirstName: OrdersArray[j].customer.first_name,
                                                                LastName: OrdersArray[j].customer.first_name == '' && OrdersArray[j].customer.last_name == '' ? OrdersArray[j].customer.id : OrdersArray[j].customer.last_name == '' ? OrdersArray[j].customer.first_name : OrdersArray[j].customer.last_name,
