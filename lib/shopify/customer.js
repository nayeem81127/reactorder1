                                                            ...
                                                            for (let j in CustomersArray) {
                                                                if (CustomersArray[j].id == acc2Records[i].ERP7__Customer_External_Id__c) {
                                                                    let acclist = {
                                                                        ...
                                                                        FirstName: CustomersArray[j].last_name == null ? '' : CustomersArray[j].first_name,
                                                                        LastName: CustomersArray[j].last_name == null ? CustomersArray[j].first_name : CustomersArray[j].last_name,
