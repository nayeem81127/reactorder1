                                    ...
                                    for (let i in CustomersArray) {
                                        if (CustomersArray[i].id != "" && CustomersArray[i].id != null) {
                                            var list = {
                                                ...
                                                Name: CustomersArray[i].first_name == "" && CustomersArray[i].last_name ? CustomersArray[i].id : CustomersArray[i].first_name + " " + CustomersArray[i].last_name,
                                                    ...
                                                    for (let j in CustomersArray) {
                                                        if (CustomersArray[j].id == acc2Records[i].ERP7__Customer_External_Id__c) {
                                                            let acclist = {
                                                                ...
                                                                LastName: CustomersArray[j].first_name == '' && CustomersArray[j].last_name == '' ? CustomersArray[j].id : CustomersArray[j].last_name == '' ? CustomersArray[j].first_name : CustomersArray[j].last_name,
